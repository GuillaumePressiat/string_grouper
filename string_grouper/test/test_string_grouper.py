...
class StringGrouperTest(unittest.TestCase):
    ...
    def test_auto_blocking_single_DataFrame(self):
        ...
        def mock_build_matches(OverflowThreshold,
            ...
            def wrapper(left_matrix,
                ...
                if (left_matrix.shape[0] + right_matrix.shape[0]) > \
                        OverflowThreshold:
                    raise OverflowError
                return real_build_matches(left_matrix, right_matrix, n_blocks)
            return wrapper
        ...
        do_test_with(OverflowThreshold=50)
        do_test_with(OverflowThreshold=40)
        do_test_with(OverflowThreshold=35)
    ...
    def test_n_blocks_single_DataFrame(self):
        ...
        test_overflow_error_with(OverflowThreshold=50, n_blocks=(1, 1))
        test_overflow_error_with(OverflowThreshold=40, n_blocks=(2, 1))
        test_overflow_error_with(OverflowThreshold=30, n_blocks=(1, 2))
